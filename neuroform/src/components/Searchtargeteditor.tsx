      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {targets.map((target, index) => (
            <div
              key={index}
              className="relative group space-y-2 border rounded-lg p-4 bg-gray-50 dark:bg-zinc-800"
            >
              <Input
              ...
              {/* Trash button inside Dialog */}
              <div className="absolute top-3 right-3">
                <Dialog>
                  <DialogTrigger asChild>
                    <button
                      type="button"
                      className="text-zinc-400 hover:text-red-500 transition-opacity opacity-0 group-hover:opacity-100"
                    >
                      <Trash size={18} />
                    </button>
                  </DialogTrigger>
